...
async function main() {
  ...
  const alAhlyPlayers = await prisma.player.createMany({
    data: [
      {
        firstName: 'Mohamed',
        lastName: 'El-Shenawy',
  ...
  const zamalekPlayers = await prisma.player.createMany({
    data: [
      {
        firstName: 'Mohamed',
        lastName: 'Awad',
  ...
  const pyramidsPlayers = await prisma.player.createMany({
    data: [
      {
        firstName: 'Sherif',
        lastName: 'Ekramy',
  ...
  const ismailyPlayers = await prisma.player.createMany({
    data: [
      {
        firstName: 'Mohamed',
        lastName: 'Fawzi',
  ...
  const elGounaPlayers = await prisma.player.createMany({
    data: [
      {
        firstName: 'Islam',
        lastName: 'Tarek',
